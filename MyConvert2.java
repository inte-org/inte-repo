	...
	//	myinv.set_CustomColumn("C_Commodity_ID",mybooking.get_Value("C_Commodity_ID"));               
		...
		{	
			...
			System.out.println("Invoice Saved Done "+ myinv.getC_Invoice_ID());                        
					  String sql="Select C_Total from Sh_Booking where IsActive='Y' and Sh_Booking_ID="+p_Sh_Booking_ID;       
		  ...
		  while(rs.next())
		  {
			  ...
			  mabp.setPriceEntered(BigDecimal.valueOf(totalline));
			  System.out.println("3"); 
			  mabp.setPriceActual(BigDecimal.valueOf(totalline));
			  System.out.println("4"); 
			  mabp.setLineNetAmt(BigDecimal.valueOf(totalline));
			  System.out.println("5"); 
			  mabp.setLineTotalAmt(BigDecimal.valueOf(totalline));
			  ...
			  mabp.setTaxAmt(BigDecimal.valueOf(totalline));            
